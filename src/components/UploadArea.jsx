      ...
      <AnimatePresence mode="wait">
        {preview ? (
          <motion.div 
            ...
            className="relative aspect-square rounded-lg overflow-hidden border-2 border-blue-500 border-dashed group"
          >
            {/* We can't use Next.js Image with dynamic src from file input, so we use regular img here */}
            <img 
              src={preview} 
              alt="Preview" 
            ...
            <button 
              ...
              className="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1.5 hover:bg-red-600 transition-colors transform hover:scale-110 shadow-lg"
            >
